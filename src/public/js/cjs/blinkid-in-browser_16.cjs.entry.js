...
(function (DocumentType) {
    ...
    DocumentType[DocumentType["COUNT"] = 49] = "COUNT";
...
let MbButton = class {
  ...
  render() {
    return (index.h(index.Host, { class: classNames({ visible: this.visible, disabled: this.disabled, icon: this.icon, selected: this.selected }), onClick: (ev) => this.handleClick(ev) }, index.h("a", { onMouseOver: this.handleMouseOver, onMouseOut: this.handleMouseOut, href: "javascript:void(0)" }, this.imageSrcDefault && this.imageAlt === 'action-alt-camera' &&
      index.h("img", { src: this.imageSrc, alt: this.translationService.i(this.imageAlt).toString() }), this.imageSrcDefault && this.imageAlt === 'action-alt-gallery' &&
      index.h("label", { htmlFor: "scan-from-image-input" }, index.h("img", { src: this.imageSrc, alt: this.translationService.i(this.imageAlt).toString() }))), this.label !== '' &&
...
let MbButtonClassic = class {
  ...
  render() {
    return (index.h(index.Host, { class: classNames({ disabled: this.disabled }), onClick: (ev) => this.handleClick(ev) }, index.h("a", { href: "javascript:void(0)" }, index.h("slot", null))));
  }
  get hostEl() { return index.getElement(this); }
};
...
let MbModal = class {
  ...
  render() {
    return (index.h(index.Host, { class: classNames({ visible: this.visible }) }, index.h("div", { class: "mb-modal" }, index.h("div", { class: "close-wrapper" }, index.h("div", { class: "close-icon", onClick: () => this.close.emit() }, index.h("svg", { width: "20", height: "20", viewBox: "0 0 20 20", fill: "none", xmlns: "http://www.w3.org/2000/svg" }, index.h("path", { "fill-rule": "evenodd", "clip-rule": "evenodd", d: "M15.5896 4.4107C15.915 4.73614 15.915 5.26378 15.5896 5.58922L5.58958 15.5892C5.26414 15.9147 4.73651 15.9147 4.41107 15.5892C4.08563 15.2638 4.08563 14.7361 4.41107 14.4107L14.4111 4.4107C14.7365 4.08527 15.2641 4.08527 15.5896 4.4107Z", fill: "#3C3C43", "fill-opacity": "0.5" }), index.h("path", { "fill-rule": "evenodd", "clip-rule": "evenodd", d: "M4.41107 4.4107C4.73651 4.08527 5.26414 4.08527 5.58958 4.4107L15.5896 14.4107C15.915 14.7361 15.915 15.2638 15.5896 15.5892C15.2641 15.9147 14.7365 15.9147 14.4111 15.5892L4.41107 5.58922C4.08563 5.26378 4.08563 4.73614 4.41107 4.4107Z", fill: "#3C3C43", "fill-opacity": "0.5" })))), index.h("div", { class: "title" }, this.modalTitle), index.h("div", { class: this.contentCentered ? 'centered' : '' }, this.content), index.h("div", { class: "actions" }, index.h("slot", { name: "actionButtons" })))));
  }
  get hostEl() { return index.getElement(this); }
};
