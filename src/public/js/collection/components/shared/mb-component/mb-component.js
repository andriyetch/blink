 ...
 */
import { Component, Element, Event, Host, h, Method, Prop, State } from '@stencil/core';
  ...
  render() {
    return (h(Host, null,
      ...
      h("mb-screen", { id: "mb-screen-error", visible: false, ref: el => this.screens.error = el },
        h("div", { class: "icon-alert" },
          h("svg", { width: "24", height: "24", viewBox: "0 0 24 24", fill: "none", xmlns: "http://www.w3.org/2000/svg" },
            h("path", { "fill-rule": "evenodd", "clip-rule": "evenodd", d: "M12 4C7.58172 4 4 7.58172 4 12C4 16.4183 7.58172 20 12 20C16.4183 20 20 16.4183 20 12C20 7.58172 16.4183 4 12 4ZM2 12C2 6.47715 6.47715 2 12 2C17.5228 2 22 6.47715 22 12C22 17.5228 17.5228 22 12 22C6.47715 22 2 17.5228 2 12Z", fill: "black" }),
            h("path", { "fill-rule": "evenodd", "clip-rule": "evenodd", d: "M12 7C12.5523 7 13 7.44772 13 8V12C13 12.5523 12.5523 13 12 13C11.4477 13 11 12.5523 11 12V8C11 7.44772 11.4477 7 12 7Z", fill: "black" }),
            h("path", { "fill-rule": "evenodd", "clip-rule": "evenodd", d: "M11 16C11 15.4477 11.4477 15 12 15H12.01C12.5623 15 13.01 15.4477 13.01 16C13.01 16.5523 12.5623 17 12.01 17H12C11.4477 17 11 16.5523 11 16Z", fill: "black" }))),
      ...
      h("mb-screen", { id: "mb-screen-action", visible: false, ref: el => this.screens.action = el },
        ...
        h("div", { class: "action-buttons" },
          h("mb-button", { ref: el => this.scanFromCameraButton = el, preventDefault: true, visible: true, disabled: false, icon: true, onButtonClick: () => this.startScanFromCamera(), imageSrcDefault: this.iconCameraDefault, imageSrcActive: this.iconCameraActive, imageAlt: "action-alt-camera", translationService: this.translationService }),
          h("input", { id: "scan-from-image-input", ref: el => this.scanFromImageInput = el, type: "file", accept: "image/*", onChange: () => this.scanFromImageInput.value && this.startScanFromImage() }),
        ...
        h("div", { class: "combined-image-upload" },
          ...
          h("mb-button-classic", { ref: el => this.combinedScanFromImageButton = el, disabled: true, onButtonClick: () => this.startScanFromImageCombined() }, this.translationService.i('process-image-upload-cta').toString()))),
      ...
      h("mb-overlay", { id: "mb-overlay-drag-and-drop", visible: false, ref: el => this.overlays.draganddrop = el },
        h("img", { class: "drag-and-drop-icon", src: this.iconGalleryDefault }),
