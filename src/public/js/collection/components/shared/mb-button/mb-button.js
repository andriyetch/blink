...
export class MbButton {
  ...
  render() {
    return (h(Host, { class: classNames({ visible: this.visible, disabled: this.disabled, icon: this.icon, selected: this.selected }), onClick: (ev) => this.handleClick(ev) },
      h("a", { onMouseOver: this.handleMouseOver, onMouseOut: this.handleMouseOut, href: "javascript:void(0)" },
